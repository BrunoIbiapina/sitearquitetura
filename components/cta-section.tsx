...
export function CTASection() {
  return (
    <section id="contato" className="relative z-10 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative overflow-hidden rounded-2xl border border-border bg-primary p-10 shadow-2xl lg:p-16">
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 h-64 w-64 rounded-full bg-accent/10 blur-3xl" />
          <div className="absolute -bottom-10 -left-10 h-48 w-48 rounded-full bg-accent/5 blur-2xl" />
          ...
          <div className="relative flex flex-col items-center gap-10 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="max-w-lg text-center lg:text-left">
              ...
              <p className="mt-4 text-lg leading-relaxed text-primary-foreground/70">
                Entre em contato e vamos conversar sobre como transformar seus
                espacos. Estou pronta para ouvir suas ideias.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                ...
                >
                  <a
                    href="mailto:contato@arqcarolina.com.br"
                    className="flex items-center gap-2"
                  >
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                },
                {
                  icon: Instagram,
                  label: "Instagram",
                  value: "@adeliaibiapina",
                },
              ].map((item) => (
                <div
                  key={item.label}
                  className="flex items-center gap-3 rounded-lg bg-primary-foreground/5 px-4 py-3"
                >
